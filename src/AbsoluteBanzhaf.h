...
public:
	/**
	 * Construct the AbsoluteBanzhaf object
	 *
	 * @param g The Game for which the absolute Banzhaf index should be calculated.
	 ...
	 */
	AbsoluteBanzhaf(Game& g, ItfUpperBoundApproximation* approx, IntRepresentation int_representation = DEFAULT);
