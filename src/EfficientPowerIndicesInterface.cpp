...
// [[Rcpp::export]]
std::map<std::string,std::vector<std::string>> ComputePowerIndex(Rcpp::String index, Rcpp::NumericVector weights, double quota, bool filterNullPlayers=false, bool verbose = false, bool weightedMajorityGame = false) {
