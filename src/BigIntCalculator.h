#ifndef EPIC_LINT_BIGINTCALCULATOR_H_
#define EPIC_LINT_BIGINTCALCULATOR_H_
...
/**
* An implementation of the ItfLargeNumberCalculator interface wrapping a bigInt variable
*
...
#endif /* EPIC_LINT_BIGINTCALCULATOR_H_ */
